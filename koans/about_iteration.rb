...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject is used to find an aggregate value by iterating through every element of an enumerable object with an initial seed value. Eg for sum, product operation.
  end
